...
void MainFrame::Initialize()
{
    ...
    helpMenu->Append(wxID_ABOUT, "&OnAbout\tF1", "Show about dialog");
    ...
    decorMenu->Append(IDMADDCASTLE, L"Castle", L"Add a Castle");
...
/**
* OnAbout menu option  handlers
 * @param event
*/
void MainFrame::OnAbout(wxCommandEvent& event)
{
    wxMessageBox(L"Welcome to the Aquarium!", L"OnAbout Aquarium", wxOK, this);
}
